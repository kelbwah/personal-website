    ...
    <Sheet className="block md:hidden lg:hidden">
      ...
      <SheetContent className="flex flex-col gap-4">
        <SheetHeader>
          <div
            onClick={() => navigate("/")}
            className="flex gap-2 cursor-pointer items-center z-30"
          >
        ...
        <section className="flex flex-col items-start w-full">
          <Button
            ...
            className="w-full py-8 flex items-center justify-start border-none font-semibold tracking-tight"
            variant="outline"
          >
            <FaRegUser className="h-6 scale-90 text-2xl mr-4" />
            Introduction
          </Button>
          <Button
            ...
            variant="outline"
          >
            <IoSchoolOutline className="h-10 scale-110 text-2xl mr-4" />
            Education
          </Button>
          <Button
            ...
            variant="outline"
          >
            <MdOutlineWorkOutline className="w-6 h-8 scale-105 mr-4" />
            Experience
          </Button>
          <Button
            ...
            variant="outline"
          >
            <GrProjects className="w-6 h-6 mr-4" />
            Projects
          </Button>
          <Button
            ...
            variant="outline"
          >
            <MdOutlineEmail className="w-6 h-6 scale-110 mr-4" />
            Contact
          </Button>
        </section>
