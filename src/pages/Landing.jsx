                    ...
                    <main className="flex flex-col items-center justify-center h-screen">
                        <div className="max-w-lg px-4 md:px-6 lg:px-8 text-center">
                            ...
                            <div className="flex items-center justify-center gap-4">
                                <Button onClick={() => navigate("/projects")} variant="outline">View Portfolio<FaArrowRight className="ml-2 h-4 w-4"/></Button>
                                <a href="https://github.com/kelbwah/personal-website" target="_blank"><Button variant="outline">Source Code<FaGithub className="ml-2 h-4 w-4"/></Button></a>
                            </div>
