...
function ProjectCard({ summary, projectTitle, projectLogo, dates, websiteLink, isDeployed }) {
    return (
        ...
        >
            ...
            <CardFooter>
                {isDeployed ? (
                    <a target="_blank" href={websiteLink}><Button>Visit Project</Button></a>
                ) : (
...
function Projects() {
    ...
    const KuizzicalLogoUrl = "https://github.com/kelbwah/Kuizzical/assets/124933520/d35f61a8-59a4-488c-a0d6-eadb7d6589e1"
